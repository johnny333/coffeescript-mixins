...
describe "module exports", ->
  ...
  describe "bootstrapping function", ->
    it "should put an include function on Function.prototype", ->
      expect(Function::incl).toBeUndefined()
      mixins.bootstrap()
      expect(Function::incl).not.toBeUndefined()
...
describe "mixin functionality", ->
  ...
  includeMixin = ->
    classes.ParentWhoExtendsWithoutOverride.incl(classes.FieldMixin)
    classes.ParentWhoExtends.incl(classes.FieldMixin)
    classes.Parent.incl(classes.FieldMixin)
    classes.ClassWithMixin.incl(classes.FieldMixin)
    classes.FooChild.incl(classes.FieldMixin)
